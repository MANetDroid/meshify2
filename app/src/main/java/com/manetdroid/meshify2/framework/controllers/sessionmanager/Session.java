...
import com.manetdroid.meshify2.framework.controllers.helper.MeshifyUtils;
import com.manetdroid.meshify2.framework.entities.MeshifyContent;
...
import com.manetdroid.meshify2.framework.entities.ResponseJson;
...
public class Session extends AbstractSession implements com.manetdroid.meshify2.api.Session, Comparable<Session> {
            ...
            switch (meshifyEntity.getEntity()) {
                ...
                case 1: {
                    ...
                    if (content.getPayload() != null) {
                        ...
                        hashMap = (HashMap) new Gson().fromJson((String) object, new TypeToken<HashMap<String, Object>>() {
                        }.getType());
                    }
